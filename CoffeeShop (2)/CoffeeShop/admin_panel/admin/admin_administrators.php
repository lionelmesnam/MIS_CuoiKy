...
if (!$result) {
    die("<font color='red'>Query Error: " . mysqli_error($conn) . "</font>");
}

while ($row = mysqli_fetch_assoc($result)) { ?>
    <tr>
        <td><img src="../../images/admins/<?php echo htmlspecialchars($row['admin_image']); ?>" class="round_img"  id="image_<?php echo $row['admin_id']; ?>" /></td>
        <td id="name_<?php echo $row['admin_id']; ?>"><?php echo htmlspecialchars($row['admin_name']); ?></td>
        <td id="phone_<?php echo $row['admin_id']; ?>"><?php echo htmlspecialchars($row['admin_phone']); ?></td>
        <td id="email_<?php echo $row['admin_id']; ?>"><?php echo htmlspecialchars($row['admin_email']); ?></td>
        <td id="username_<?php echo $row['admin_id']; ?>"><?php echo htmlspecialchars($row['admin_username']); ?></td>
        <td id="password_<?php echo $row['admin_id']; ?>"><?php echo htmlspecialchars($row['admin_password']); ?></td>
        <td>
